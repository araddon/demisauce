(function($)
{
    ...
    $.extend($.ds, {
        auth: function(user_key) {
          user_ckie = $.cookie('userkey');
          if (user_ckie == undefined || user_ckie == null){
            var url = this.defaults.base_url + '/account/init_user/' + encodeURIComponent(user_key) + '?site_slug=' + encodeURIComponent(this.defaults.site_slug) ;
