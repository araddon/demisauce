...
Credits to Alberto and original authors:
http://groups.google.com/group/pylons-discuss/browse_frm/thread/f4937f5fdf98e64d/3a8db9b9262cc607#3a8db9b9262cc607
http://toscat.net/~alberto/scheduler.py

Demisauce: Modifications:
- Scheduler.add_interval_task:  
      the first "if   interval  "  etc was an OR, changed to and
- IntervalTask.reschedule():  changed if interval = 0 then only run once
"""
#
...
class Scheduler:
    ...
    def add_interval_task(self, action, interval, args=None, kw=None,
        ...
        if initialdelay<0 and interval<1:
